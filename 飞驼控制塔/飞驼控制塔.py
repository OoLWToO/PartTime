...
if __name__ == '__main__':
    ...
    if direct_response['content'] == 0:
        ...
        for r in direct_response['content']:
            detail_url = f'https://openapi.freightower.com/application/schedule/p2p/group?polCode={polCode}&podCode={podCode}&etd={search_date}&eta=&weeksOut=8&pageNum=1&pageSize=10000&isTransit=0&displayGroup={r["groupName"]}'
            detail_response = requests.get(url=detail_url, headers=headers).json()
            print()
