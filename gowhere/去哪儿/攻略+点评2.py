...
scenery_list = ['鼓浪屿', '平潭县', '连江县', '南澳县', '长海县', '长岛县']
scenery_id_list = ['369313', '297222', '297215', '298782', '299079', '297205']
raiders_url = 'https://travel.qunar.com/place/api/html/books/dist/{}?sortField=0&pageSize=50&page={}'
...
if __name__ == '__main__':
    for i in range(len(scenery_list)):
        ...
        #         title = ''.join(gonglue_ele.xpath('.//h3/a//text()'))
        #         try:
        ...
        for page in range(1, 101):
            ...
            for dianping_ele in dianping_eles:
                try:
                    dianping_url = dianping_ele.xpath('(.//*[@data-beacon="comment_pic"])[1]/@href')[0]
                except:
                    dianping_url = ''
                if dianping_url:
                    ...
                    try:
                        ...
                        title = ''
                    try:
                        user = html.xpath('//*[@class="usr_info"]/a/text()')[0]
                    except:
                        user = ''
                    try:
                        sorce = html.xpath('//*[@class="e_comment_brief"]//*[@class="total_star"]/span/@class')[0][-1]
                    except:
                        sorce = ''
                    try:
