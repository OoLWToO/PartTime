...
def get_school_list():
    ...
    for regionId in regionId_list:
        for features in features_list:
            school_search_url = f'https://kaoyan.cqvip.com/api/kaoyan/info/school/index-page?current=1&size=1000&regionId={regionId}&feature={features}'
            ...
            try:
                ...
                for score_line in score_line_list:
                    if score_line['majorCode'] == major['code']:
                        ...
                        print(f'{school_name}   {position}   {school_creation_time}   {school_affiliation}   {school_floor_space}   '
